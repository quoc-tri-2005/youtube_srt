...
HẠN CHẾ TỐI ĐA:
sự tình,phương diện,thực lực,cấp tốc,cáo tri,hồi đáp,minh bạch,phát giác,cơ duyên,thiên phú,nghịch tập,đả kích,đích thân,bất quá,dẫu sao,vô cùng,cực kỳ,đương nhiên,thậm chí
ƯU TIÊN:
chuyện,mặt,khả năng,nhanh chóng,cho biết,trả lời,hiểu rõ,phát hiện,cơ hội,tài năng,lật ngược tình thế,gây ảnh hưởng,tự mình,nhưng,dù sao,rất,rất,tất nhiên,ngay cả
ĐẶC BIỆT QUAN TRỌNG:
...
Ví dụ:
明白了 → hiểu rồi,告诉你 → nói cho bạn biết,发现 → phát hiện ra,立刻 → ngay,情况 → tình hình,事情 → chuyện,于是 → nên,因为 → vì,正在 → đang,
QUAN TRỌNG:
